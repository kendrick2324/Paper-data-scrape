...
#https://api2.openreview.net/notes?content.venue=NeurIPS%202024%20oral&details=replyCount,presentation&domain=NeurIPS.cc/2024/Conference&limit=25
#以下路径为openreview中的ICLR 2024会议的论文数据
...
id_dict['poster']=get_id(path_poster,73)
id_dict['decisionPending']=get_id(path_decisionPending,142)

for i in id_dict.values():#打印每种级别论文的数量
    print(len(i))
    
output_file_path = 'data\id_dict.json'
with open(output_file_path, 'w') as json_file:#将论文id保存到json文件中
